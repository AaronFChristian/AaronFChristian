...
**LangGraph · RAG · LLM Evaluation · Multi-Agent Systems · Python · SQL · Pinecone · Snowflake · Power BI · Tableau**
...
- **Agentic RAG pipelines** with hybrid retrieval, citation validation, and sufficiency guardrails
- **Multi-agent evaluation systems** that audit AI output before it reaches a human
- **LLM benchmarking frameworks** scoring faithfulness, relevancy, and hallucination rates
...
**AI/ML:** LangGraph · LangChain · Anthropic Claude · RAG · Pinecone · BM25 · Ragas · LangSmith  
**Data:** SQL · Snowflake · dbt · ETL · Pandas · NumPy  
**BI:** Power BI · Tableau · Looker Studio · DAX  
**Infra:** FastAPI · FastMCP · GitHub Actions · Vercel  
...
- Retrieval hit rate improved from **58% → 81%**, hallucinated citations reduced to **zero**
- Ragas faithfulness **0.86** · LangSmith tracing · MCP server · React frontend on Vercel
...
- Critic agent scores every profile against **5 structured criteria** before any slate ships
- Schema-validated JSON contracts between agents · multi-provider (Claude / GPT-4o / Gemini)
...
- Deepening expertise in **LLM observability** (LangSmith, Ragas, evals)
- Targeting **AI Analyst / AI Engineer** roles at the intersection of AI systems and analytics
